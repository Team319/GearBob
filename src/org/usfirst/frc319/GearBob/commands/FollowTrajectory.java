...
public class FollowTrajectory extends Command {
    ...
    RobotMap.drivetrainright2.changeControlMode(TalonControlMode.Follower);
    RobotMap.drivetrainright2.set(RobotMap.drivetrainrightLead.getDeviceID());
    RobotMap.drivetrainright3.changeControlMode(TalonControlMode.Follower);
    RobotMap.drivetrainright3.set(RobotMap.drivetrainrightLead.getDeviceID());
    RobotMap.drivetrainright4.changeControlMode(TalonControlMode.Follower);
    RobotMap.drivetrainright4.set(RobotMap.drivetrainrightLead.getDeviceID());
    RobotMap.drivetrainleft7.changeControlMode(TalonControlMode.Follower);
    RobotMap.drivetrainleft7.set(RobotMap.drivetrainleftLead.getDeviceID());
    RobotMap.drivetrainleft8.changeControlMode(TalonControlMode.Follower);
    RobotMap.drivetrainleft8.set(RobotMap.drivetrainleftLead.getDeviceID());
    RobotMap.drivetrainleft9.changeControlMode(TalonControlMode.Follower);
    RobotMap.drivetrainleft9.set(RobotMap.drivetrainleftLead.getDeviceID());
