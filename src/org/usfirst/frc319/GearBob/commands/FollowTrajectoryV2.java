...
public class FollowTrajectoryV2 extends Command {
	...
	// constructor
	public FollowTrajectoryV2(String trajectoryName) {
	...
	protected void initialize() {
		...
		setUpTalon(RobotMap.drivetrainrightLead);
		setUpTalon(RobotMap.drivetrainleftLead);

		SrxNotifier.startPeriodic(.005);
		this.traj = importer.importSrxTrajectory(trajectoryToFollow);
		int pidfSlot = Robot.driveTrain.DRIVE_PROFILE;
		...
		*/
		...
		fillTalonBuffer(RobotMap.drivetrainrightLead, this.traj.rightProfile, pidfSlot);
		fillTalonBuffer(RobotMap.drivetrainleftLead, this.traj.leftProfile, pidfSlot);
	...
	protected void execute() {
		...
		RobotMap.drivetrainrightLead.getMotionProfileStatus(rightStatus);
		RobotMap.drivetrainleftLead.getMotionProfileStatus(leftStatus);
		...
		RobotMap.drivetrainleftLead.set(setValue.value);
		RobotMap.drivetrainrightLead.set(setValue.value);
	}
	...
	protected void end() {
		SrxNotifier.stop();
		resetTalon(RobotMap.drivetrainrightLead, TalonControlMode.PercentVbus, 0);
		resetTalon(RobotMap.drivetrainleftLead, TalonControlMode.PercentVbus, 0);
	}
